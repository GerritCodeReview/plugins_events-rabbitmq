...
public abstract class StreamSession implements Session {
  ...
  public synchronized boolean connect() {
     ...
     * Alternative DNS in certificate properly. Needed in case you have not configured 
     * the RabbitMQ cluster to use node names with full FQDN. If not using full FQDN it
     * is assumed that the nodes use same domain as specified in stream.uri.
     */
